const nodes = {
    // --- Col 0 (x=45) ---
    "n100_0_0": { h: 100, pos: [130, 120] },
    "n100_0_1": { h: 100, pos: [130, 220] },
    "n85_0_3": { h: 85, pos: [130, 420] },
    "n75_0_4": { h: 75, pos: [130, 520] },
    "n100_0_7": { h: 100, pos: [130, 715] },

    // --- Col 1 (x=165) ---
    "n100_1_0": { h: 100, pos: [250, 120] },
    "n100_1_1": { h: 100, pos: [250, 220] },
    "n60_1_2": { h: 60, pos: [250, 320] },
    "n70_1_5": { h: 70, pos: [250, 600] }, // Big 70
    "n85_1_6": { h: 85, pos: [250, 675] },
    "start_90": { h: 90, pos: [250, 810] },

    // --- Col 2 (x=270) ---
    "n100_2_0": { h: 100, pos: [355, 120] },
    "n25_mid": { h: 25, pos: [425, 220] },
    "n45_2_2": { h: 45, pos: [355, 320] },
    "n50_2_3": { h: 50, pos: [355, 420] },
    "n75_2_5": { h: 75, pos: [355, 600] },
    "n80_2_6": { h: 80, pos: [355, 675] },
    "n75_2_7": { h: 75, pos: [355, 715] },

    // --- Col 3 (x=405) ---
    "n40_3_2": { h: 40, pos: [490, 320] },
    "n30_3_3": { h: 30, pos: [490, 420] },
    "n70_3_5": { h: 70, pos: [490, 600] },
    "n66_3_6": { h: 66, pos: [490, 675] },
    "n67_3_7": { h: 67, pos: [550, 675] }, // Dead end
    "n70_3_7b": { h: 70, pos: [490, 715] },

    // --- Col 4 (x=525) ---
    "n10_mid": { h: 10, pos: [550, 220] },
    "n7_4_1": { h: 7, pos: [610, 220] },
    "n6_4_2": { h: 6, pos: [610, 320] },
    "n80_4_4": { h: 80, pos: [610, 520] },
    "n75_4_5": { h: 75, pos: [610, 600] },
    "n68_4_6": { h: 68, pos: [610, 675] },
    "n69_4_7": { h: 69, pos: [610, 715] },

    // --- Col 5 (x=610) ---
    "goal_0": { h: 0, pos: [825, 40] },
    "n1_5_1": { h: 1, pos: [695, 220] },
    "n3_5_2": { h: 3, pos: [695, 320] },
    "n10_5_3": { h: 10, pos: [695, 420] },
    "n50_5_3b": { h: 50, pos: [695, 470] },
    "n45_5_4": { h: 45, pos: [695, 520] },
    "n50_5_5": { h: 50, pos: [695, 600] },
    "n65_5_7": { h: 65, pos: [695, 715] },

    // --- Col 6 (x=740) ---
    "n3_6_0": { h: 3, pos: [825, 120] },
    "n20_6_3": { h: 20, pos: [825, 420] },
...
const edges = [
    ...
    ["n100_1_0", "n100_1_1", 8, []],
    ["n100_1_1", "n100_2_0", 10, [[250, 120]]], // Elbow up then right
    ["n60_1_2", "n100_2_0", 10, []], // Diagonal up-right (straight diagonal is correct here)

    // --- Top-right cluster ---
    ["n100_2_0", "n10_mid", 10, [[550, 120]]], // Elbow right then down
    ["n25_mid", "n10_mid", 11, []],
    ["n10_mid", "goal_0", 10, [[825, 220]]], // Elbow right then up
    ["goal_0", "n1_5_1", 1, [[825, 220]]], // Down then left
    ["goal_0", "n3_6_0", 2, []], // Straight vertical
    ["n1_5_1", "n3_5_2", 2, []],
    ["n3_6_0", "n20_6_3", 10, [[900, 120], [900, 420]]], // Outer wall elbow right then down then left

    // --- Mid-left cluster ---
    ["n60_1_2", "n50_2_3", 11, [[355, 320]]], // Elbow right then down (ortho)
    ["n60_1_2", "n70_1_5", 16, [[355, 320], [355, 495], [250, 495]]], // Right, down, left to 70
    ["n85_0_3", "n75_0_4", 15, []],
    ["n75_0_4", "n100_0_7", 35, []],
    ["n75_0_4", "n70_1_5", 20, [[250, 520]]], // Elbow right then down

    // --- Center cluster ---
    ["n45_2_2", "n40_3_2", 5, []],
    ["n40_3_2", "n50_2_3", 6, [[355, 320]]], // Elbow left then down (passing near 45)
    ["n50_2_3", "n30_3_3", 10, [[355, 545], [490, 545]]], // Down then right then up to 30
    ["n30_3_3", "n6_4_2", 8, [[610, 420]]], // Elbow right then up
    ...
    ["n66_3_6", "n50_5_5", 8, [[695, 675]]], // Horizontal right then up to 50
    ["n66_3_6", "n67_3_7", 2, [[490, 745], [550, 745]]], // Down to 720, then right then up
    ...
    ["n69_4_7", "n65_5_7", 1, []], // Horizontal right to 65

    // --- Bottom-left cluster ---
    ["n75_2_7", "n80_2_6", 3, []], // Up
